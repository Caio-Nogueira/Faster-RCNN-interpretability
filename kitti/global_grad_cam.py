...
model.load_state_dict(torch.load(models_dict["kitti_reg"], map_location=device))
model.to(device)
...
output = utils.interpretation_heatmap(cam2, img, pred_bbox, contrastive, f"generated/alternative_grad_cam/reg_cam2_{seed}.jpg")
output = utils.interpretation_heatmap(cam3, img, pred_bbox, contrastive, f"generated/alternative_grad_cam/reg_cam3_{seed}.jpg")
output = utils.interpretation_heatmap(cam4, img, pred_bbox, contrastive, f"generated/alternative_grad_cam/reg_cam4_{seed}.jpg")
...
output = utils.interpretation_heatmap(final_cam, img, pred_bbox, contrastive, f"generated/alternative_grad_cam/reg_cam_final_{seed}.jpg")